...
export SPARK_MASTER_HOST=zhsffydjcs.localdomain
export SPARK_MASTER_PORT=7077
export YARN_CONF_DIR=/opt/software/hadoop-2.7.7/etc/hadoop
export SPARK_HISTORY_OPTS="-Dspark.history.ui.port=18080 -Dspark.history.retainedApplications=24 -Dspark.history.fs.logDirectory=hdfs://zhsffydjcs.localdomain:9000/spark-jobhistory"